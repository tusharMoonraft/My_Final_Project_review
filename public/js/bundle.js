...
/*eslint-disable*/
var displayMap = function displayMap(locs) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 10:
            _context.prev = 10;
            _context.t0 = _context["catch"](1);
            (0, _alert.showAlert)('error from signup page', _context.t0.response);
...
// const stripe=Stripe('pk_test_51IkDcFSDqzJpaiG4b5ErtpFyntNRlmrvPns6rV0beajl9o5ZSFpojRkjLk4zwr3iRsVhvVJpYFHov0mwf93ARqND00Jr1wN80D')
...
if (mapBox) {
  var locs = JSON.parse(document.getElementById('map').dataset.location);
  (0, _mapbox.displayMap)(locs);
}

if (signupForm) {
  btnsignup.addEventListener('click', function (e) {
    console.log("gone"); // const name=document.getElementById('name').value
